...
export default function StatCard({ title, amount, color }: { title: string, amount?: number, color: string }) {
    ...
    return (
        <div className={'flex flex-col border-1 border-gray-300  rounded-lg p-4 w-full dark:border-gray-700 dark:bg-gray-800 '}>
            <h3 className={'text-nowrap  dark:text-gray-100'}>{title}</h3>
