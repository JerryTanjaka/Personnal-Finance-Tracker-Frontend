...
export default function TransactionCard({
  ...
  return (
    <div
      className={`group relative scale-99 min-h-40 rounded-xl cursor-pointer border border-gray-300 bg-gray-100 p-4 shadow-sm transition-transform duration-200 hover:scale-100 hover:shadow-md ${
