...
export default function NavBar() {
   ...
   return (
      <nav
         className={`m-6 flex h-[94vh] flex-col justify-between rounded-lg bg-gray-100 p-6 shadow-[0px_0px_5px_5px_rgba(0,0,0,0.25)] transition-all duration-300 ${isExpanded ? 'w-64' : 'w-20'}`}
